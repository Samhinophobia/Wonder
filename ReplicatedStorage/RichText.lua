...
defaults.TextSize = 10 -- Only applicable if TextScaled = false
...
function animationStyles.Wiggle(character, animateAlpha, properties)
	character.Visible = true
	-- Custom Endless Shake Hack!
	local shakeX = math.random(-2, 2)
	local shakeY = math.random(-2, 2)
	character.Position = properties.InitialPosition + UDim2.new(0, shakeX, 0, shakeY)
end
